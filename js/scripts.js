    ...
    $(function(){
            ...
            var accuwetherAPIKey = "wC95KWlNX2CzUX7tjHxe0LwXFjCszLBh";
            var mapBoxToken = "pk.eyJ1IjoiYXVndXN0b2xpbWEiLCJhIjoiY2t6MGx5YnpuMWRlcDJ1bXdpZHh4cDdxYyJ9.cNKzNF-axFmwphpOEzb2FA";
            ...
            function preencherClimaAgora(cidade, estado , pais, temperatura, texto_clima, icone_clima) {
                ...
                $("#icone_clima").css("background-image", "url('" + wetherObject.icone_clima + "')" );
            ...
            function pegarPrevisãoHoraAHora(localCode) {
                $.ajax ({
                    ...
                    success: function(data){
                       // console.log("hourly forecast: ",data);
                        ...
                        for (var a = 0; a < data.length; a++) {
                             ...
                             gerarGrafico(horarios, temperatura);
                    ...
                    error: function() {
                    console.log("Erro");
                    gerarErro("Erro ao obter hora a hora ")
                    }
                });
            ...
            function preencherPrevisao5Dias(previsoes)  {
                ...
                for (var a = 0; a < previsoes.length; a++) {
                    ...
                    maxima = String(previsoes[a].Temperature.Minimum.Value);
                    minima = String(previsoes[a].Temperature.Maximum.Value);
            ...
            function pegarTempoAtual(localCode) {
                $.ajax ({
                    ...
                    dataType: "json",
                    success: function(data){
                      //  console.log("curret conditions: ",data);

                        wetherObject.temperatura = data[0].Temperature.Metric.Value;
                        wetherObject.texto_clima = data[0].WeatherText;

                        var iconNumber = data[0].WeatherIcon <= 9 ? "0" + String(data[0].WeatherIcon) : String(data[0].WeatherIcon);

                        wetherObject.icone_clima = "https://developer.accuweather.com/sites/default/files/" + iconNumber + "-s.png";

                        preencherClimaAgora(wetherObject.cidade, wetherObject.estado , wetherObject.pais, wetherObject.temperatura, wetherObject.texto_clima, wetherObject.icone_clima);
                    },
                ...
                $.ajax ({
                    ...
                    success: function(data){
                     //   console.log("geoposition: ", data);
                        ...
                        try {
                                wetherObject.cidade = data.ParentCity.LocalizedName;
                        } 
                        catch {
                                wetherObject.cidade = data.LocalizedName;
                        }

                        
                        wetherObject.estado = data.AdministrativeArea.LocalizedName;
                        wetherObject.pais = data.Country.LocalizedName;
               ...
               $.ajax ({
                   ...
                   success: function(data){
                        ...
                        pegarLocalUsuario(data.geoplugin_latitude,data.geoplugin_longitude);
                            ...
                            pegarLocalUsuario(lat_padrao,data.lat_padrao);
                        }
                   },
